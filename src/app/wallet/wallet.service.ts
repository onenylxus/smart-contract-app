...
export class WalletService {
  ...
  public getTransactions(address: string): Observable<any> {
    return this.http.get(`https://api-rinkeby.etherscan.io/api?module=account&action=txlist&address=${address}&startblock=0&endblock=99999999&page=1&offset=10&sort=asc&apikey=${environment.apiKey}`);
  }
}
